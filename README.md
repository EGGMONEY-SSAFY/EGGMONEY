...
| 이름 | 역할 |   
| --- | --- |
| 나경준 | [팀장]<br/> 소셜 로그인, 회원 관리, 1원 인증, QR코드<br/> S3, 회원 관련 프런트 디자인, 발표 | 
| 곽재은 | [프런트 리더] <br/>주식 매수 및 매도 기능, 알림<br/> 공통 컴포넌트, PWA, 팀 내 컨벤션 관리 | 
| 김신범 | 주식 매수 및 매도 기능, 알림<br/>  Chat GPT를 활용한 뉴스 요약 기능 | 
| 정지영 | 예적금, 대출 기능 <br/>UCC 제작, ERD 회의 기록 |
| 황우성 | 예적금, 대출 기능 <br/> 하둡, 스파크, SQOOP를 활용한 예적금 추천 알고리즘 제작<br/>금융 퀴즈 백로직<br/>인프라 서포트 |  
| 정소영 | 인프라 CI/CD 구축<br/> 회원 & 전체 페이지 프런트 디자인<br/> 이벤트 (퀴즈,게임,룰렛), DailyScrum 정리 |  
