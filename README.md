...
| 이름 | 역할 |   
| --- | --- |
| 나경준 | [팀장]<br/> 카카오 소셜 로그인 기능 <br/>회원 관리 로직 제작 <br/> QR코드를 활용한 가족 연결 기능<br/>간편 비밀번호 제작 <br/> 입금계좌 등록 및 1원 인증 기능 구현<br/> S3를 활용한 데이터 관리 <br/> PPT 제작 및 발표 | 
...
| 김신범 | 주식 분석 및 종목 확인 기능 (차트 포함)  <br/> 주식 매수 및 매도 기능 (거래내역 및 주문현황) <br/>알림 기능 (예적금 가입, 대출 심사, 출금 요청 등)<br/>  Chat GPT를 활용한 뉴스 요약 기능 | 
...
| 정소영 | 인프라 CI/CD 구축<br/> 회원 & 전체 페이지 프런트 디자인<br/> 이벤트 담당 (경제 용어 퀴즈, 행운의 금융 룰렛, 돈 먹기 게임, 물가 맞추기 게임)<br/>DailyScrum 정리, Readme 작성 |  
