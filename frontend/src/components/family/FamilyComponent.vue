<template>
    <div class="p-6 min-h-screen bg-gray-100">
      <div class="space-y-8">
        ...
        >
          <img src="@/assets/family/가족 생성.png" alt="가족 생성 아이콘" class="w-16 h-16"> <!-- 이미지 크기 증가 -->
        ...
        <div 
          ...
          class="flex items-center space-x-6 cursor-pointer bg-white hover:bg-gray-100 p-8 rounded-lg shadow-md transition-transform transform hover:scale-105"
        >
          <img src="@/assets/family/내 가족.png" alt="내 가족 아이콘" class="w-16 h-16"> <!-- 이미지 크기 증가 -->
        ...
        <div 
          ...
          class="flex items-center space-x-6 cursor-pointer bg-white hover:bg-gray-100 p-8 rounded-lg shadow-md transition-transform transform hover:scale-105"
        >
          <img src="@/assets/family/가족 초대.png" alt="가족 초대 아이콘" class="w-16 h-16"> <!-- 이미지 크기 증가 -->
        ...
        <div 
          ...
          class="flex items-center space-x-6 cursor-pointer bg-white hover:bg-gray-100 p-8 rounded-lg shadow-md transition-transform transform hover:scale-105"
        >
          <img src="@/assets/family/가족 연결.png" alt="가족 연결 아이콘" class="w-16 h-16"> <!-- 이미지 크기 증가 -->
      ...
      <div class="bg-white p-6 rounded-lg shadow-lg text-center">
        ...
        <input type="file" @change="handleFileUpload" class="p-2 border border-gray-300 rounded mt-4 w-full" />
        <input type="text" v-model="familyDescription" placeholder="가족 소개" class="p-2 border border-gray-300 rounded mt-4 w-full">
        <button class="px-4 py-2 bg-orange-500 text-white font-semibold rounded-lg mt-4" @click="createFamily">
          가족 생성
        </button>
