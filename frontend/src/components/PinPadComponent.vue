<template>
  <div class="pin-pad relative">
    <!-- 실제 이미지 -->
    <img :src="pinPadImage" class="w-full" alt="Pin Pad" />
    ...
    <!-- 버튼들 -->
    <button
      class="absolute bottom-4 left-4 bg-gray-500 text-white py-2 px-4 rounded"
      @click="onBackClick"
    >
      뒤로가기
    </button>
    <button
      class="absolute bottom-4 right-4 bg-orange-500 text-white py-2 px-4 rounded"
      @click="onCheckClick"
    >
      확인
    </button>
